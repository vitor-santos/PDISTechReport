...
%%----------------------------------------
\title{Conceção, desenvolvimento e teste de serviços móveis inovadores baseados numa aplicação móvel de pagamento para Transportes Públicos de Passageiros}
\author{Vítor Hugo Coelho Santos}
...
\supervisor{Orientador}{Maria Teresa Galvão Dias}
